...
def preset(node,method):
    ...
    node.parm('path_pos').set('`chs("_project")`/textures/`chs(\"_component\")`_pos.exr')
    node.parm('path_rot').deleteAllKeyframes()
    node.parm('path_rot').set('`chs("_project")`/textures/`chs(\"_component\")`_rot.exr')
    node.parm('path_scale').deleteAllKeyframes()
    node.parm('path_scale').set('`chs("_project")`/textures/`chs(\"_component\")`_scale.exr')    
    node.parm('path_norm').deleteAllKeyframes()
    node.parm('path_norm').set('`chs("_project")`/textures/`chs(\"_component\")`_norm.exr')
    node.parm('path_col').deleteAllKeyframes()
    node.parm('path_col').set('`chs("_project")`/textures/`chs(\"_component\")`_col.exr')
    node.parm('path_uv').deleteAllKeyframes()
    node.parm('path_uv').set('`chs("_project")`/textures/`chs(\"_component\")`_uv.exr')    
